...
import com.duitku.e_study.Adapter.AdapterChooseQUiz;
...
public class ChooseQuiz extends AppCompatActivity {
    ...
    private AdapterChooseQUiz Adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter = new AdapterChooseQUiz(this,AllMateriList);
                ...
                if(response.isSuccessful()) {
                    ...
                    if (response.body().getMetadata() != null) {
                        ...
                        if(status.equals(Constant.ERR_200)) {
                            ...
                            rvHistoriTrx.setAdapter(new AdapterChooseQUiz(mContext, AllMateriList));
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ChooseQuiz.this, LoginActivity.class));
                        finish();
